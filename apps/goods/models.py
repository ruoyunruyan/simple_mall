...
class GoodsChannel(BaseModel):
    """商品频道"""
    group = models.ForeignKey(GoodsChannelGroup, related_name='channels', verbose_name='频道组名')
    category = models.ForeignKey(GoodsCategory, related_name='category', on_delete=models.CASCADE, verbose_name='顶级商品类别')
...
class SKUImage(BaseModel):
    """SKU图片"""
    sku = models.ForeignKey(SKU, related_name='images', on_delete=models.CASCADE, verbose_name='sku')
